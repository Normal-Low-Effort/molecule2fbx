...
$output = Join-Path $workspace "outputs\1SB-LSD_RR"
...
$arguments = @(
    ...
    "--smiles", $smiles,
    "--name", "1SB-LSD_RR",
    "--reuse-calculations", (Join-Path $workspace "outputs\1SB-LSD_RR_redo\1SB-LSD_RR_dft_calculations"),
    "--nprocs", "16",
    "--maxcore", "1000",
    "--output-dir", $output,
    "--orca", $orca,
...
@{
    ...
    source_reuse_directory = (Join-Path $workspace "outputs\1SB-LSD_RR_redo\1SB-LSD_RR_dft_calculations")
